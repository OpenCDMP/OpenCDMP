...
@Component
@Qualifier(TenantScopeImpl.QualifierName)
@RequestScope
public class TenantScopeImpl implements TenantScope {
    public static final String QualifierName = "tenantScopeImpl";
    ...
    @Autowired
    public TenantScopeImpl(MultitenancyConfiguration multitenancyConfiguration) {
