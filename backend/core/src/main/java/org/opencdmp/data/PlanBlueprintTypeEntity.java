...
import org.opencdmp.data.converters.enums.PlanBlueprintTypeStatusConverter;
...
@Entity
@Table(name = "\"PlanBlueprintType\"")
public class PlanBlueprintTypeEntity extends TenantScopedBaseEntity {
    ...
    @Column(name = "name", length = PlanBlueprintTypeEntity._nameLength, nullable = false)
    private String name;
    ...
    @Convert(converter = PlanBlueprintTypeStatusConverter.class)
