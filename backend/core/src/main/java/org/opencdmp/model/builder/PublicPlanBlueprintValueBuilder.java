...
import org.opencdmp.model.PublicPlanBlueprintValue;
...
@Component("publicplanblueprintvaluebuilder")
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class PublicPlanBlueprintValueBuilder extends BaseBuilder<PublicPlanBlueprintValue, PlanBlueprintValueEntity> {
    ...
    @Autowired
    public PublicPlanBlueprintValueBuilder(
            ConventionService conventionService) {
        super(conventionService, new LoggerService(LoggerFactory.getLogger(PublicPlanBlueprintValueBuilder.class)));
    }

    public PublicPlanBlueprintValueBuilder authorize(EnumSet<AuthorizationFlags> values) {
        this.authorize = values;
        return this;
    }

    public PublicPlanBlueprintValueBuilder withDefinition(DefinitionEntity definition) {
        this.definition = definition;
        return this;
    }

    @Override
    public List<PublicPlanBlueprintValue> build(FieldSet planBlueprintValues, List<PlanBlueprintValueEntity> data) throws MyApplicationException {
        ...
        List<PublicPlanBlueprintValue> models = new ArrayList<>();
        for (PlanBlueprintValueEntity d : data) {
            ...
            if (fieldEntity != null && fieldEntity.getCategory().equals(PlanBlueprintFieldCategory.Extra)) {
                ...
                PublicPlanBlueprintValue m = new PublicPlanBlueprintValue();
