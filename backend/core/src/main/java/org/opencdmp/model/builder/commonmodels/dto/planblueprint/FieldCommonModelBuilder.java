...
@Component("dto.planblueprint.FieldCommonModelBuilder")
@Scope(value = ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public abstract class FieldCommonModelBuilder<Model extends Field, Entity extends FieldModel> extends BaseCommonModelBuilder<Model, Entity> {
