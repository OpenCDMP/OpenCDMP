...
public class PlanPropertiesCensor extends BaseCensor {
    ...
    private static final LoggerService logger = new LoggerService(LoggerFactory.getLogger(PlanPropertiesCensor.class));

    protected final AuthorizationService authService;
    protected final CensorFactory censorFactory;

    public PlanPropertiesCensor(ConventionService conventionService,
