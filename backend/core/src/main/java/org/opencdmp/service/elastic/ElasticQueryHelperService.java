...
public interface ElasticQueryHelperService {
    ...
    QueryResult<Plan> collectPublic(PlanLookup lookup, EnumSet<AuthorizationFlags> authorizationFlags, FieldSet fieldSet);
    ...
    QueryResult<Description> collectPublic(DescriptionLookup lookup, EnumSet<AuthorizationFlags> authorizationFlags, FieldSet fieldSet);
