...
export class PlanBlueprintTypeEditorModel extends BaseEditorModel implements PlanBlueprintTypePersist {
	name: string;
	code: string;
	status: PlanBlueprintTypeStatus = PlanBlueprintTypeStatus.Draft;
	permissions: string[];
	...
	public fromModel(item: PlanBlueprintType): PlanBlueprintTypeEditorModel {
		if (item) {
